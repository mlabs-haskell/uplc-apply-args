...
use apply_args_browser::apply_params_to_script_no_panic;
use pallas_primitives::Fragment;
use uplc::{PlutusData, BigInt, Constr, plutus_data_to_bytes};
...
fn main () {
    ...
    let applied_script = apply_params_to_script_no_panic(&unit_js, &script0a_bytes).unwrap();
    print!("applied\n");
